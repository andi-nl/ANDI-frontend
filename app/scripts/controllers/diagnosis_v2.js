...
app.controller('TableController', function($scope) {
  ...
  this.createPatientObject=function(){
   var age= this.calculateAge($scope.patient[0].age);
   dum= {"patient.id":$scope.patient[0].id,
         "patient.age":age,
         "patient.sex":$scope.patient[0].sex,
         "patient.education":$scope.patient[0].education,
         "patient.test":$scope.patient[0].test
        };
   return dum;
  };
