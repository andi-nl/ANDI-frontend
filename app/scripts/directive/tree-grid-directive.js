angular
    ...
    .run([
      ...
      function ($templateCache) {
            ...
            "           <span class=\"has-error\" ng-show=\"row1.patient.form.id{{row1.treeIndex}}.$error.duplicate\">Please make sure all patients have a unique id before file upload !</span> </td>\n"+
            "        </tr>\n" +
            "      <tr>\n" +
            "        <td class=\"left-td\" ng-if=\"row1.treeIndex === 0\">age</td>\n" +
            "        <td>\n" +
            "        <input ng-disabled=\"treeDisable\" ng-keyup=\"treeTableControl.disableDate(row1.treeIndex)\"  type=\"number\" name=\"age{{row1.treeIndex}}\" id=\"age{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex].age\">\n" +
//            "           <span class=\"has-error\" ng-show=\"row1.patient.form.age{{row1.treeIndex}}.$error.required && treeTableControl.submited\">Required<br/></span>\n" +
  //          "          <span class=\"has-error\" ng-show=\"row1.patient.form.age{{row1.treeIndex}}.$error.number\">Not valid number!</span> </td>\n" +
            "        </td>\n" +
            "      </tr>\n" +

            "      <tr>\n" +
            "        <td class=\"left-td\" ng-if=\"row1.treeIndex === 0\">birthdate</td>\n" +
            "        <td>\n" +
            "        <input ng-disabled=\"treeDisable\" ng-change=\"treeTableControl.calculateAge(row1.treeIndex)\" type=\"date\" name=\"birthdate{{row1.treeIndex}}\" id=\"birthdate{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex]['birthdate']\" required>\n" +
            "           <span class=\"has-error\" ng-show=\"row1.patient.form.birthdate{{row1.treeIndex}}.$error.required && treeTableControl.submited\">Required</span> </td>\n" +
            "        </td>\n" +
            "      </tr>\n" +

            "      <tr>\n" +
            "        <td class=\"left-td\" ng-if=\"row1.treeIndex === 0\">testdate</td>\n" +
            "        <td>\n" +
            "        <input ng-disabled=\"treeDisable\" ng-change=\"treeTableControl.calculateAge(row1.treeIndex)\" type=\"date\" name=\"testdate{{row1.treeIndex}}\" id=\"testdate{{row1.treeIndex}}\" ng-model=\"row1.patient[row1.treeIndex]['testdate']\" required>\n" +
            "           <span class=\"has-error\" ng-show=\"row1.patient.form.testdate{{row1.treeIndex}}.$error.required && treeTableControl.submited\">Required</span> </td>\n" +
            "        </td>\n" +
            "      </tr>\n" +
            "      <tr>\n" +
            ...
            "          <span class=\"has-error\" ng-show=\"row1.patient.form['test{{row1.treeIndex}}_{{row.id}}'].$error.min\">Enter value between {{row.branch.lowweb}} to {{row.branch.highweb}}</span>\n" +
            "          <span class=\"has-error\" ng-show=\"row1.patient.form['test{{row1.treeIndex}}_{{row.id}}'].$error.max\">Enter value between {{row.branch.lowweb}} to {{row.branch.highweb}}</span>\n" +
            "          <span class=\"has-error\" ng-show=\"row1.patient.form['test{{row1.treeIndex}}_{{row.id}}'].$error.number\">Not valid number!</span> </td>\n" +
            "       </td>\n" +
            "     </tr>\n" +
            " </table>\n" +
            "</div>\n" +
